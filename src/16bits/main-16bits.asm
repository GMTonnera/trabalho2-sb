...
%include "src/16bits/sum-16bits.asm"
%include "src/16bits/sub-16bits.asm"
%include "src/16bits/div-16bits.asm"
%include "src/16bits/mul-16bits.asm"
%include "src/16bits/exp-16bits.asm"
%include "src/16bits/mod-16bits.asm"
...
msg3  db ', bem vindo ao programa de CALC IA-16', 0dh, 0ah
len_msg3 EQU $-msg3
